...
class TemperatureUnitsButtons extends Component<ITemperatureUnitsButtonsProps> {
	...
	render() {
		return (
			...
			<Button variant="info" className="celsius-button" onClick={this.highlightButton}/>
            <Button variant="outline-info" className="fahrenheit-button" onClick={this.highlightButton}/>
            </div>
		);
	}
}
